...
import pers.julio.notepad.recyclerview.R;
...
public abstract class MyBaseAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    protected int LayoutID; // = R.layout.base_item;
    ...
    public MyBaseAdapter(Context mContext,int layoutID, List<T> datas, boolean useDataAddress) {
