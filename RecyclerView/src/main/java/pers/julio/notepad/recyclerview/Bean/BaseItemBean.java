...
public class BaseItemBean {
    ...
    public BaseItemBean(Object flag,int id, String text, String key, String value, Drawable logo, Drawable state, boolean isSelected, boolean showState) {
        Id = id;
        Flag = flag;
        Text = text;
        Key = key;
    ...
    public static class Builder {
        ...
        public final Builder setFlag(Object flag) {
            mFlag = flag;
            return this;
        }
        ...
        public final BaseItemBean build() {
            ...
            return new BaseItemBean(mFlag,mId,mText,mKey,mValue,mLogo,mState,mSelected,mShowState);
        }
    }
}
